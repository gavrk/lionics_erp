...
class CompanyLoc(models.Model):
    ...
    passport_series = models.CharField(max_length=250)
    passport_number = models.CharField(max_length=250)
    pass_issued_by = models.CharField(max_length=250)
    pass_issued_date = models.CharField(max_length=100)
    pass_issued_code = models.CharField(max_length=500)
    postal_addr = models.CharField(max_length=500)
    registration_addr = models.CharField(max_length=500)
